...
export const openNavigation = () => {
    tl.to("#navigationoverlay2", 0.6, { scale: window.innerWidth <= 1366 ? 100 : 70, ease: "expo.inOut" })
       ...
       .to("#navigationmainlinks", 0.7, { y: -50, opacity: 1, stagger:{ amount: 0.4 }, ease: "power4.out" })
       .to("#navigationaddress", 0.7, { y: -30, opacity: 1, stagger:{ amount: 0.4 }, ease: "power4.out"}, "<");
}

export const closeNavigation = () => {
    tl.to("#brand", 0.3, { opacity: 0, ease: "power4.out" })
      .to("#navigationaddress", 0.7, { y: 30, opacity: 0, stagger:{ amount: 0.4, from: "end" }, ease: "power4.out" }, "<")
      .to("#navigationmainlinks", 0.7, { y: 50, opacity: 0, stagger:{ amount: 0.4, from: "end" }, ease: "power4.out" }, "<")
