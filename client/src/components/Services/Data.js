...
export const setAssetsForServices = (
  ...
  if (path === "web") {
    ...
    setBannerText("With elegant performance across every platform, our modern web frameworks to give your business a one-stop web solution service.");
    ...
    setBannerText("Streamline your business needs through our comprehensive mobile software solutions service to meet the needs of modern day industry.");
    ...
    setBannerText("Seamlessly integrate your ideas into IoT prototypes to simulate the idea before going into the market among the consumers.");
    ...
    setBannerText("Incorporate modern branding & marketing strategies to channel your brand in front of the right consumers through our services.");
