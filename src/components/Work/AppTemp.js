    ...
    <>
      <div className="webtemp">
        ...
        <div className="firstHead">
          <h1>
            <div>
              <span id="aboutprocesshead">Case</span>
            </div>
            <div>
              <span id="aboutprocesshead">Studies</span>
            </div>
          </h1>
        </div>
        ...
        <h1>
          <div>
            <span id="aboutprocesshead">Project</span>
          </div>
          <div>
            <span id="aboutprocesshead">Highlights</span>
          </div>
        </h1>
        <div className="apptemp__slides">
